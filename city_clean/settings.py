"""
Django settings for city_clean project.
...
SECRET_KEY = 'django-insecure-g9^cu%6ct1_wufd9$i^rp98n*dyvlwkd-_k=i&o&d8)=$oz#_^'
...
WSGI_APPLICATION = 'city_clean.wsgi.application'
